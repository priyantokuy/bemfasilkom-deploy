  ...
  return (
    <>
        <div className={`${bismitMode? 'bg-transparent' : 'bg-red-600 bg-gradient-cust-orange2 p-[.1rem]'} lg:flex group rounded-[10px] w-fit  lg:m-auto `}>
            <a href={`/event`} className={`group from-[#FA6D01] to-[#FA870199] via-yellow-500 relative overflow-hidden md:w-full ${width!=''? width :' lg:w-[13rem]'} flex justify-center py-[.35rem] font-medium 
