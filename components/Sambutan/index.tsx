        ...
        <section ref={boxRef} data-scroll-section className='flex h-full lg:max-w-[283px] lg:w-[30%]  '>
            <section className='mt-8 w-full lg:mt-0 lg:w-fit h-full flex lg:flex-col lg:items-center justify-between'>
                <figure className='w-[40%] h-[40%] lg:w-fit lg:h-fit flex flex-col items-center lg:mb-10'>
                    <Image className='rounded-full overflow-hidden bg-cover object-cover' src={ketuaUmum.foto ? API_URL + ketuaUmum.foto.url : 'placeholder_image_url'} width={200} height={200} alt='Ketua'/>
                ...
                <figure className='w-[40%] h-[40%] lg:w-fit lg:h-fit flex flex-col items-center'>
                    <Image className='rounded-full overflow-hidden bg-cover mb-1 object-cover' src={wakilKetua.foto ? API_URL + wakilKetua.foto.url : 'placeholder_image_url'} width={200} height={200} alt='Wakil'/>
                    <figcaption className='text-center mt-2'>
